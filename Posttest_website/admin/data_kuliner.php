<?php 
    ...
    if(isset($_POST['submit'])){
        ...
        if(move_uploaded_file($tmp, 'gambar_data/'.$gambar_baru)){
            $query = "INSERT INTO data_kuliner (judul, deskripsi, resep, nama) VALUES ('$judul','$deskripsi','$resep','$gambar_baru')";
            $hasil = $db->query($query);

            if($hasil){
                header("Location:informasi/info_kuliner.php");
            }else{
                echo "gagal kirim";
            }
        }
...
<body>
    ...
    <a id = "lihat-data" href="informasi/info_kuliner.php">Lihat Data</a>
