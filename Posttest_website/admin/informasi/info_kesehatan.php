<?php 
    ...
    $query = "SELECT * FROM data_kesehatan";
...
if(isset($_GET['cari'])){
    ...
    $hasil = mysqli_query($db, "SELECT * FROM data_kesehatan WHERE judul LIKE '%keyword%' OR deskripsi LIKE '%keyword%' ");
} else{
    $hasil = mysqli_query($db, "SELECT * FROM data_kesehatan");
}
